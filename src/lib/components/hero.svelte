<script>
	...
	$: src = theme ? 'images/hero/tasklyst_dark.png' : 'images/hero/tasklyst_light.png';
	...
	onMount(async () => {
		try {
			...
			// Assuming changelog.json structure:
			// { "latest": "v1.2.3", "downloads": { "windows": "...", "linux": "..." } }

			latestVersion = data.version;
			downloadLinks = data.download_urls;
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="ud-hero-content wow fadeInUp" data-wow-delay=".2s">
					<h1 class="ud-hero-title">A Lightweight Task Manager<br /> That Just Works</h1>
					<p class="ud-hero-desc">
						A fast, distraction-free task manager built for simplicity and control. Runs natively on
						Windows, macOS, and Linux — no accounts, no clutter, just you and your tasks.
					</p>
					<ul class="ud-hero-buttons flex flex-col sm:flex-row gap-3">
						...
						<li>
							<DownloadButton
								...
								link={downloadLinks.linux_x86_64}
								version={latestVersion}
							/>
						</li>
					</ul>
				...
				<div class="ud-hero-image wow fadeInUp" data-wow-delay=".25s" style="margin-top: 1cm;">
					<div align="left">
						<Themeswitch
							on:toggle={(e) => {
								theme = e.detail;
					...
					/>
					<img src="images/hero/dotted-shape.svg" alt="shape" class="shape shape-1" height="25%" />
				</div>
			</div>
		</div>
	</div>
