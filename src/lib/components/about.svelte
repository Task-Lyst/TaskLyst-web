<script>
	...
	function loadTheme() {
		theme = typeof localStorage !== 'undefined' ? localStorage.getItem('theme') !== 'dark' : false;
	}
			...
			<div class="ud-about-content-wrapper">
				<div class="ud-about-content">
					...
					<div style="display: flex; flex-direction: column; gap: 12px;">
						...
						<div>📴&nbsp;&nbsp; Offline-first – no forced accounts or cloud sync</div>
						<div>🧩&nbsp;&nbsp; Custom task types & tags</div>
						<div>📊&nbsp;&nbsp; Configurable task table (columns, order, etc.)</div>
						<div>🕓&nbsp;&nbsp; Start/due times, priority, completion tracking</div>
						<div>💾&nbsp;&nbsp; Backup & restore support</div>
						<div>⚙️&nbsp;&nbsp; Launches at boot, tray icon for fast access</div>
